...
<div class="mtg-form-plugin">
	...
	<div class="wrap">
		<h1 class="wp-heading-inline">Pop-up Setting - MTARGET Form</h1>
			<?php if ( '' === $form_id ) { ?>
				Pop-up is not set. Start by selecting a form. <a href="admin.php?page=mailtarget-form-plugin--admin-menu-widget-form&for=popup">Select Form</a>
			<?php } ?>
			<?php if ( '' !== $form_id ) { ?>
